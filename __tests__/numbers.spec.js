...
const { processEvent } = require("../src/handlers/numbers-handler");
...
describe("Helper functions work", () => {
    test("processEvent works with correct headers and queryString parameters", () => {
        ...
        expect(processEvent({ headers : headers, queryStringParameters: queryStringParameters })).toMatchObject({ ...headers, ...{ limit: 1 } });
    });
